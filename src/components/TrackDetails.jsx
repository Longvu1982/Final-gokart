	...
	return (
		<div className="flex items-center justify-between flex-wrap gap-y-6">
			<div className="flex gap-4 items-end">
				...
				<span className="text-[50px] leading-[50px] font-semibold text-gray-100">{trackInfo.laps}</span>
			</div>
			<div className="flex gap-4 items-end">
				<div className="font-semibold text-gray-400 text-lg">
				...
				<span className="text-[50px] leading-[50px] font-semibold text-gray-100">{trackInfo.length}</span>
			...
			<div className="flex gap-4 items-end">
				...
				<span className="text-[50px] leading-[50px] font-semibold text-gray-100">
